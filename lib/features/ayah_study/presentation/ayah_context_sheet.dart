...
import '../../tafsir/presentation/tafsir_tab_content.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  switch (activeTab) {
                    ...
                    // Al-Muyassar — see [TafsirTabContent]'s doc comment)
                    // replaces the never-built Meaning tab, 2026-09-13.
                    // Extracted to its own file
                    // (tafsir/presentation/tafsir_tab_content.dart) — same
                    // reasoning as GrammarTabContent/MorphologyTabContent
                    // below: this tab is the Tafsir feature's real entry
                    // point now (moved from the Actions Row, not retired),
                    // so its code belongs in that feature's own
                    // presentation layer, not inline here.
                    StudyTab.tafsir => TafsirTabContent(
                        ayahKey: ayahKey,
                        tafsirRepository: tafsirRepository,
                      ),
...
/// tab was open — on every tick; since `TafsirTabContent`/
